...
if __name__ == '__main__':
    ...
    for model_id in models_ids:
        encoder_weights_file = f"../models/zinc_paired_model/zinc_encoder_iris2_{model_id}.h5"
    ...
    np.save(
        f"../models/zinc_paired_model/averaged_metrics_for_zinc_encoder_iris2_{model_id[0]}_to_{model_id[-1]}.npy",
        metrics_for_all_models
    )